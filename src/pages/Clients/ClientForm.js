        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              maxLength="15"
              className={`w-full pl-10 pr-4 py-2 border rounded-lg uppercase focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:text-white ${
